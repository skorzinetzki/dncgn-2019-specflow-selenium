...
namespace specflow_livedemo_specs
{
    ...
    public class ScrumTrainingSteps
    {
        ...
        {
            _driver.FindElement(By.CssSelector("#page-header > div > div.col-md-11 > button.menu-btn")).Click();
        }
        ...
        public void WhenIClickOnScrumTrainings()
        {
            ...
            Assert.AreEqual("SCRUM TRAININGS", element.Text.Trim());
            element.Click();
        }
        ...
        {
            Assert.IsTrue(_driver.Url.TrimEnd('/').EndsWith(expectedUrlPath));
        }
    }
}
